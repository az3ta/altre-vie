    ...
    this.innerHTML = /*html*/ `
      ...
      >
        <div class="flex flex-col justify-center p-4 md:p-0 w-full md:w-2/3 gap-4 md:gap-6 mx-auto">
          <h2 class=" text-rosso text-3xl sm:text-4xl md:text-5xl lg:text-6xl animate-fade-left animate-once animate-duration-1000 animate-delay-100 animate-ease-in animate-normal animate-fill-backwards">Benvenut!</h2>
          <div class="flex flex-col gap-1 sm:gap-2 md:gap-4 text-lg sm:text-xl md:text-2xl text-rosso animate-fade-left animate-once animate-duration-1000 animate-delay-[1100ms] animate-ease-in animate-normal animate-fill-backwards">
          ...
          <button 
            ...
            class="text-blu hover:bg-blu hover:text-white text-center w-fit px-4 text-lg sm:text-2xl md:text-3xl rounded-full  border-2 border-solid border-blu animate-fade-left animate-once animate-duration-1000 animate-delay-[2100ms] animate-ease-in animate-normal animate-fill-backwards"
          >
            ENTRA
          </button>
        </div>
